...
**Source of truth for CSS tokens:** `project/tokens.css` and `frontend/src/app/globals.css`
...
See `frontend/src/app/globals.css` for the live implementation and `project/tokens.css` for the documented canonical
version.
