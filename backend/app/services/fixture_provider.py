...
DOCS = [
    # Purchase Contract Documents mirror Brett's Colorado click-to-complete checklist.
    ("Contract to Buy and Sell Real Estate", "purchase_contract", "", "approved"),
    ("Earnest Money Receipt", "purchase_contract", "", "missing"),
    ("Counterproposal", "purchase_contract", "", "missing"),
    ("Amend / Extend Contract", "purchase_contract", "", "missing"),
    ("Notice to Terminate Contract", "purchase_contract", "", "missing"),
    ("Inspection Objection", "purchase_contract", "", "missing"),
    ("Inspection Resolution", "purchase_contract", "", "missing"),
    ("Appraisal Objection", "purchase_contract", "", "missing"),
    ("Appraisal Resolution", "purchase_contract", "", "missing"),
    ("Title Objection", "purchase_contract", "", "missing"),
    ("Title Resolution", "purchase_contract", "", "missing"),
    ("Due Diligence Documents", "purchase_contract", "", "missing"),
    ("Closing Instructions", "purchase_contract", "", "missing"),
    ("Additional Provisions Addendum", "purchase_contract", "", "missing"),
    ("Personal Property Agreement", "purchase_contract", "", "missing"),
    ("Seller Concessions Addendum", "purchase_contract", "", "missing"),
    ("Backup Contract Addendum", "purchase_contract", "", "missing"),
    ("Post-Closing Occupancy Agreement", "purchase_contract", "", "missing"),
    ("Agreement to Amend Deadline", "purchase_contract", "", "missing"),
    ("Loan Application", "financing", "", "reviewed"),
    ("Loan Estimate", "financing", "", "missing"),
    ("Closing Disclosure", "financing", "", "missing"),
    ("Title Commitment", "title_escrow", "", "missing"),
    ("Title Insurance Policy", "post_closing", "", "missing"),
    ("Settlement Statement", "closing", "", "missing"),
    ("Tax Certificate", "title_escrow", "", "missing"),
    ("HOA Status Letter", "colorado_specific", "", "missing"),
    ("General Home Inspection Report", "inspection_due_diligence", "", "missing"),
    ("Radon Test Results", "inspection_due_diligence", "", "missing"),
    ("Sewer Scope Report", "inspection_due_diligence", "", "missing"),
    ("Final Walkthrough Confirmation", "closing", "", "missing"),
    ("Wire Confirmation", "closing", "", "missing"),
    ("Closing Package Receipt", "closing", "", "missing"),
    ("Recorded Deed Copy", "post_closing", "", "missing"),
    ("Owner’s Title Policy", "post_closing", "", "missing"),
    ("Final Brokerage File Audit", "brokerage_compliance", "", "missing"),
    ("Signed Agency Disclosures", "brokerage_compliance", "", "missing"),
    ("Earnest Money Tracking", "brokerage_compliance", "", "missing"),
    ("Communication Log", "brokerage_compliance", "", "missing"),
    ("Commission Record", "brokerage_compliance", "", "missing"),
    ("File Retention Confirmation", "brokerage_compliance", "", "missing"),
]
