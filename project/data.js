// data.js — mock transaction data for the Altitude prototype.
// One concrete deal so every screen feels like the same real thing:
// rural single-family in Conifer with septic, well, HOA road agreement.

window.ALT_DATA = (function () {
  const property = {
  ...
  // Stages cycle through to demo the timeline.
  const stages = [
  ...
  // Checklist — every item has 4 states. Conditional items (septic/well/HOA)
  // demonstrate N/A behaviour for cash/condo deals.
  ...
  // Calendar — key dates over the next ~3 weeks
  const deadlines = [
  ...
  // The other transactions on the dashboard
  const dashboard = [
    {
      id: 'tx-1', address: '4287 Pine Ridge Trail', city: 'Conifer',
      stage: 'Appraisal', daysToClose: 15, progress: 0.62,
      next: 'Appraisal due Tue', urgent: true, parties: 'Okafor · Hayes',
      price: 962500, active: true,
    },
    {
      id: 'tx-2', address: '1108 Cherry Creek Dr', city: 'Denver',
      stage: 'Inspection Resolution', daysToClose: 22, progress: 0.34,
      next: 'BIR due Thu', urgent: false, parties: 'Nguyen · Park',
      price: 1295000, active: false,
    },
    {
      id: 'tx-3', address: '722 Pearl St #4B', city: 'Boulder',
      stage: 'Under Contract', daysToClose: 38, progress: 0.18,
      next: 'Title ordered', urgent: false, parties: 'Whitmore · Foss',
      price: 680000, active: false,
    },
    {
      id: 'tx-4', address: '55 Mountain View Rd', city: 'Evergreen',
      stage: 'Clear to Close', daysToClose: 4, progress: 0.92,
      next: 'CD signed — funds Mon', urgent: false, parties: 'Reyes · Templeton',
      price: 1450000, active: false,
    },
  ];
  ...
  return {
    property, parties, stages, checklist, deadlines, documents,
    notes, dashboard, summary, postClose,
